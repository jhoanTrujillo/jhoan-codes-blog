...
class CommentsEditor {
  ...
  deleteButtonSetup(deleteButton) {
    ...
    if (deleteButton.dataset.comment_id !== "") {
      const deleteConfirmButton = document.querySelector("[data-inherit-id]")
      const deleteConfirmData = deleteConfirmButton.dataset
      deleteConfirmData.inheritId = deleteButton.dataset.commentId
      deleteConfirmButton.href = `delete_comment/${deleteConfirmData.inheritId }`;
    }
  }
